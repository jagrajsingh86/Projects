...
client = OpenAI(api_key="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")
import newspaper
...
def generate_text_with_openai(user_prompt):
    completion = client.chat.completions.create(model="gpt-3.5-turbo",  # you can replace this with your preferred model
    messages=[
