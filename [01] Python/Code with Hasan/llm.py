...
client = OpenAI(api_key="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")
import nlpcloud
import cohere
import json
...
def openai_generate(user_prompt, selected_model):
    completion = client.chat.completions.create(model=selected_model, messages=[{"role": "user", "content": user_prompt}])
